...
class hMLP_stem(nn.Module):
    ...
    with slight modifications
    """
    def __init__(self, img_size=224,  patch_size=8, in_chans=3, embed_dim=768,norm_layer=nn.SyncBatchNorm):
        super().__init__()
...
@register_model
def deit_base_patch8_LS(pretrained=False, img_size=224, pretrained_21k = False,  **kwargs):
    model = vit_models(
